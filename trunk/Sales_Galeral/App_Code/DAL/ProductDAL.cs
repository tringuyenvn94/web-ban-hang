    ...
    public bool Update_Product(int id, int CategoryID, string Name, string ProductCode, double PriceOriginal, double PriceSale, double PriceDiscount, int QuantityIn, int QuantityBought, string Image, string Description, string Details, int Type)
    {
        try
        {
            if (id != 0)
            {
                ...
                SqlParameter pr_ProductName = command.Parameters.Add("@Name", SqlDbType.VarChar);
                pr_ProductName.Value = Name;
                SqlParameter pr_ProductCode = command.Parameters.Add("@Product_Code", SqlDbType.VarChar);
                ...
                SqlParameter pr_Image = command.Parameters.Add("@Image", SqlDbType.VarChar);
                pr_Image.Value = Image;
                SqlParameter pr_Description = command.Parameters.Add("@Description", SqlDbType.VarChar);
                pr_Description.Value = Description;
                SqlParameter pr_Details = command.Parameters.Add("@Details", SqlDbType.Text);
