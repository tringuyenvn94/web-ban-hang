        ...
        <asp:GridView ID="grvItemShopping" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Số lượng/Cập nhật" FooterStyle-Width="20px">
                    ...
                    <ItemStyle Width="20%" />
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxQuantity" runat="server" Text='<%# Bind("Quantity") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Thành tiền">
                    <ItemTemplate>
                        <asp:Label ID="lblPrice" runat="server" Text=' <%# FunctionLibrary.DisplayPrice(double.Parse(DataBinder.Eval(Container.DataItem, "AMOUNT").ToString())) %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
            ...
            <HeaderStyle BackColor="#6A9FC7" Font-Bold="True" ForeColor="White" Height="30px" Font-Size="15px" CssClass="sectiontableheader" />
